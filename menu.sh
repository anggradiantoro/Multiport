...
name=$(curl -sS https://raw.githubusercontent.com/RazVpn/ipm/main/IP/REGIP | grep $IPVPS | awk '{print $2}')
exp=$(curl -sS https://raw.githubusercontent.com/RazVpn/ipm/main/IP/REGIP | grep $IPVPS | awk '{print $3}')
